    ...
    for content in application_content:
        ...
        for application_text in application_text_list:
            ...
            if application_name == options.application_name:
                ...
                streaming_context_list = s_html.xpath('//span[@id="activeBatches"]/h4/a')
                ...
                for streaming_context in streaming_context_list:
                    ...
                    # print(active_batch)
                streaming_records_list = s_html.xpath('//*[@id="active-batches-table"]/tbody/*/td[2]')

                # 清洗 record
                for records in streaming_records_list:
                    record = records.text
                streaming_scheduling_delay_list = s_html.xpath('//*[@id="active-batches-table"]/tbody/*/td[3]')
